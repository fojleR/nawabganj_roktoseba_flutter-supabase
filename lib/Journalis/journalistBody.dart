                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        FutureBuilder(
                          future: DefaultAssetBundle.of(context).loadString('lib/assets/journalist.json'), // Assuming Journalist.json is in the assets folder
                            ...
                            if (snapshot.hasData) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  // Access data for each Journalist
                                  var Journalist = data[index];
                                  return JournalistCard(
                                    JournalistName: Journalist['name'],
                                    address: Journalist['location'],
                                    media : Journalist['media'],
                                    phoneNumber: Journalist['mobile'],
                                  );
                                },
                              );
                            } else {
