...
import 'fireCard.dart';

class FireBody extends StatelessWidget {
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        FutureBuilder(
                          future: DefaultAssetBundle.of(context).loadString('lib/assets/fireService.json'), // Assuming Fire.json is in the assets folder
                            ...
                            if (snapshot.hasData) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  // Access data for each Fire
                                  var Fire = data[index];
                                  return FireCard(
                                    FireName: Fire['name'],
                                    address: Fire['location'],
                                    phoneNumber: Fire['mobile'],
                                  );
                                },
                              );
                            } else {
